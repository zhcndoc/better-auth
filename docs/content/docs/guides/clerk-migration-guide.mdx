...
<Steps>
  ...
  <Step>
    ...
    前往 Clerk 控制台并 [导出用户](https://clerk.com/docs/deployments/exporting-users#export-your-users-data-from-the-clerk-dashboard)。这将下载一个包含用户数据的 CSV 文件。您需要将其保存为 `exported_users.csv` 并放到项目根目录中。
  </Step>
...
Better Auth 提供了更大的灵活性和更多功能——务必浏览[文档](/docs)以充分发挥其潜力。
