  ...
  fields={[
   {
    ...
    },
    {
      name: "icon",
      type: "string",
      description: "OAuth 客户端的图标",
      isOptional: true
    },
    {
      name: "name",
      type: "string",
      description: "OAuth 客户端的名称"
    },
    { 
      name: "redirectUrls",
      type: "string", 
      description: "重定向 URL 的逗号分隔列表"
    },
    { 
      name: "metadata", 
      type: "string",
...
<DatabaseTable
  fields={[
    ...
    { 
      name: "accessToken",
      type: "string",
      description: "颁发给客户端的访问令牌",
      isUnique: true
    },
    { 
      name: "refreshToken",
      type: "string",
      description: "颁发给客户端的刷新令牌",
      isUnique: true
    },
    { 
      name: "accessTokenExpiresAt", 
      type: "Date", 
      description: "访问令牌的过期日期"
    },
    { 
      name: "refreshTokenExpiresAt", 
      type: "Date", 
      description: "刷新令牌的过期日期"
    },
    { 
      name: "clientId", 
      type: "string", 
    ...
    { 
      name: "scopes", 
      type: "string", 
      description: "授予范围的逗号分隔列表"
    },
    {
      name: "createdAt",
      type: "Date",
      description: "访问令牌创建时间戳"
    },
    {
      name: "updatedAt",
      type: "Date",
...
<DatabaseTable
  fields={[
    ...
    { 
      name: "scopes", 
      type: "string", 
      description: "同意范围的逗号分隔列表"
    },
    { 
      name: "consentGiven", 
      type: "boolean", 
      description: "表示是否已给予同意"
    },
    {
      name: "createdAt",
      type: "Date",
      description: "给予同意的时间戳"
    },
    {
      name: "updatedAt",
      type: "Date",
