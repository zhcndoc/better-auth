...
- **兼容 OIDC**：遵循 [OIDC](https://openid.net/specs/openid-connect-core-1_0.html) 标准，支持 `openid` 范围
  ...
  - **OIDC 注销**：[RP发起](https://openid.net/specs/openid-connect-rpinitiated-1_0.html)的注销支持
- **动态客户端注册**：允许客户端动态注册
