...
<Callout type="important">
  在继续之前，您需要先配置好 Better Auth 实例。如果尚未设置，请查阅我们的[安装指南](/docs/installation)。
</Callout>
...
<Callout type="tip"> 对于 TypeScript 使用者：请确保 `tsconfig.json` 中包含 `"esModuleInterop": true`，以获得最佳兼容性。 </Callout>
